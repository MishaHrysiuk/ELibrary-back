...
using EntityHistoryHelper = ELibrary.EntityHistory.EntityHistoryHelper;
...
namespace ELibrary.Auditing
{
    ...
    public class AuditLogAppService : ELibraryAppServiceBase, IAuditLogAppService
    {
        ...
        private readonly IAuditLogExcelAppService _auditLogExcelAppService;
        ...
        public AuditLogAppService(
            ...
            IAuditLogExcelAppService auditLogExcelAppService)
        {
            ...
            _auditLogExcelAppService = auditLogExcelAppService;
        }
        ...
        public async Task<FileDto> GetAuditLogsToExcel(GetAuditLogsInput input)
        {
            ...
            return _auditLogExcelAppService.ExportAuditLogsToFile(auditLogListDtos);
        }
        ...
        public async Task<FileDto> GetEntityChangesToExcel(GetEntityChangeInput input)
        {
            ...
            return _auditLogExcelAppService.ExportEntityChangesToFile(entityChangeListDtos);
        }
