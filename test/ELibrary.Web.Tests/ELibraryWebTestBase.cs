...
{
    public abstract class ELibraryWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ELibraryWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ELibraryWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ELibraryDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ELibraryDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ELibraryDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ELibraryDbContext, Task<T>> func)
        {
            T result;
